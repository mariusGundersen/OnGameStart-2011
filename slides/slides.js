...
var PERMANENT_URL_PREFIX = 'slides/';//'http://html5slides.googlecode.com/svn/trunk/';
...
function addEventListeners() {
  ...
  document.addEventListener('keydown', handleBodyKeyDown, true);  
};
